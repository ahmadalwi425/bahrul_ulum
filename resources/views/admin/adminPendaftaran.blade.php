        ...
        <div class="row align-items-center py-4">
          ...
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-dark">
                <li class="breadcrumb-item active">Jumlah Status Diminta : {{$jumlahrequest}}</li>
            </ol>
          </nav>
              ...
              <table class="table align-items-center table-flush datatables">
                ...
                <tbody class="list">                    
                    ...
                    <tr>
                        ...
                        <a href="{{ url('admin/pendaftaran/diterima',$row->id) }}" class="badge badge-dot mr-4">
                          <button class="btn btn-success" type="button"><i class="fa fa-check text-white mt--2 mr-3"></i> Terima</button>
                        </a>
                        <a href="{{ url('admin/pendaftaran/ditolak',$row->id) }}" class="badge badge-dot mr-4">
                          <button class="btn btn-danger" type="button"><i class="fa fa-trash text-white mt--2 mr-3"></i> Tolak</button>
                        </a>
                        @else
