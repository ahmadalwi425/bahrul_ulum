    ...
    <div class="container-fluid d-flex align-items-center">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <h1 class="display-2 text-white"> {{$data[0]->siswa_nama}}</h1>
          <p class="text-white mt-0 mb-3">Ini adalah halaman profil <strong>{{$data[0]->siswa_nama}}</strong>.</p>
        </div>
      </div>
    </div>
  </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="nama" class="form-control" name="nama" placeholder="Nama" value="{{$data[0]->siswa_nama}}">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-control-label" for="email">Email address</label>
                      <input type="email" name="email" id="email" class="form-control" placeholder="bigdata@example.com" value="">
                    </div>
                  </div>
                </div>
                <div class="row">
