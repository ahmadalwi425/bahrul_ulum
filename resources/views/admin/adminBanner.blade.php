        ...
        <div class="card">
          ...
          <div class="card-header border-0 pb-0">
            <div class="mb-0 pb-0 row justify-content-between">
              ...
              <a href="{{url('/admin/banner/create')}}" type="button" class="btn-success btn col-lg-2 col-12 mt-3 mt-lg-0 mb-0">
              ...
              <table class="table align-items-center table-flush datatables">
                ...
                <tbody class="list">                    
                  ...
                  <tr>
                      ...
                      <td><img src="{{asset('img_banner/'.$row->banner_image)}}" alt="" style="width:200px;height:100px;"></td>
                      <td>
