    ...
    <div class="col">
        ...
        <div class="card-body pt-0">
            <form action="{{url('admin/berita/store')}}" method="post" enctype="multipart/form-data">
                ...
                @endif
                <h6 class="heading-small text-muted mb-4">Edit Berita</h6>
                <div class="pl-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="judul">Judul</label>
                            <input type="text" id="judul" class="form-control" name="berita_judul" placeholder="judul" values="{{$data->berita_judul}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea name="berita_konten" class="ckeditor" id="ckeditor">{!!$data->berita_konten!!}</textarea>
                        </div>
                    </div>
                </div>
