...
<div class="header bg-primary pb-6">
    ...
    <div class="header-body">
        ...
        <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-3">lembaga</h6>
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                <li class="breadcrumb-item">
                <a href="{{url('/admin')}}"><i class="fa fa-home text-primary"></i> Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{url('/admin/lembaga')}}"></i> lembaga</a></li>
...
<div class="container-fluid mt--6">
    ...
    <div class="col">
        ...
        <div class="card-body pt-0">
            <form action="{{url('admin/lembaga/update/'.$data->id)}}" method="post">
                @csrf
                @method('PUT')
                @if(count($errors) > 0)
                    <div class="row">
                ...
                @endif
                <h6 class="heading-small text-muted mb-4">Tambahkan lembaga Baru</h6>
                <div class="pl-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="nama">nama</label>
                            <input type="text" id="nama" class="form-control" name="lembaga_nama" placeholder="nama" value="{{$data->lembaga_nama}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                </div>
