    ...
    <div class="header-body">
        ...
        <div class="col-lg-6 col-7">
            ...
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                ...
                <li class="breadcrumb-item"><a href="{{url('/admin/program')}}"></i> Program</a></li>
    ...
    <div class="col">
        ...
        <div class="card-body pt-0">
            <form action="{{url('admin/program/store')}}" method="post" enctype="multipart/form-data">
                ...
                @endif
                <h6 class="heading-small text-muted mb-4">Tambahkan Program Baru</h6>
                <div class="pl-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="judul">Judul</label>
                            <input type="text" id="judul" class="form-control" name="program_judul" placeholder="judul">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label" for="program_cover">Gambar</label>
                            <input type="file" id="gambar" class="form-control" name="gambar" placeholder="Banner">
                            <input type="hidden" value="o" id="program_konten" class="form-control" name="program_konten" placeholder="Banner">
                        </div>
                    </div>
                </div>
