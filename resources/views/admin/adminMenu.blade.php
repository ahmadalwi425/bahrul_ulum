                ...
                <tbody class="list">                    
                    ...
                    <tr>
                        ...
                        <a href="{{ url('admin/lembaga/menu',$row->id) }}" class="badge badge-dot mr-4">
                          <button class="btn btn-primary" type="button"><i class="fa fa-pencil text-white mt--2 mr-3"></i> Edit Konten</button>
                        </a>
                        </td>
                        <td>
                        <a href="{{ url('admin/siswa/edit',$row->id) }}" class="badge badge-dot mr-4">
