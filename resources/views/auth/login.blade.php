...
<head>
  ...
  <title>Login - Halaman Admin PPBU</title>
  <!-- Favicon -->
...
<body class="bg-default">
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-gradient-primary py-6 py-lg-6 pt-lg-5">
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Selamat Datang!</h1>
              <p class="text-lead text-white">di halaman admin <br><strong>Yayasan Pondok Pesantren Bahrul Ulum</strong>.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5 align-items-center text-center">
                <a class="avatar avatar-lg rounded-circle mb-5" href="javascript:void(0)">
              ...
              @csrf
                <div class="form-group col">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input id="name" type="name" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="name" autofocus>
                    @error('username')
